...
public class SudokuUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        newGame6X6.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
    ...
    private void newGameActionPerformed(ActionEvent evt) {//GEN-FIRST:event_newGameActionPerformed
        grid = Sudoku.GRID_9X9;
        int[][] puzzle = sudoku.getNewPuzzle(grid, gameMode);
        createBoard(puzzle);
    }//GEN-LAST:event_newGameActionPerformed

    private void resetGameActionPerformed(ActionEvent evt) {//GEN-FIRST:event_resetGameActionPerformed
        int[][] puzzle = sudoku.resetPuzzle();
        createBoard(puzzle);
    }//GEN-LAST:event_resetGameActionPerformed

    private void intermediatorActionPerformed(ActionEvent evt) {//GEN-FIRST:event_intermediatorActionPerformed
        gameMode = Sudoku.GAME_MODE_MEDIUM;
        int[][] puzzle = sudoku.getNewPuzzle(grid, gameMode);
        createBoard(puzzle);
    }//GEN-LAST:event_intermediatorActionPerformed

    private void expartActionPerformed(ActionEvent evt) {//GEN-FIRST:event_expartActionPerformed
    ...
    private void beginnerActionPerformed(ActionEvent evt) {//GEN-FIRST:event_beginnerActionPerformed
        gameMode = Sudoku.GAME_MODE_EASY;
        int[][] puzzle = sudoku.getNewPuzzle(grid, gameMode);
        createBoard(puzzle);
    }//GEN-LAST:event_beginnerActionPerformed

    private void newGame6X6ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_newGame6X6ActionPerformed
    ...
    private void resumeActionPerformed(ActionEvent evt) {//GEN-FIRST:event_resumeActionPerformed
        stopWatch.resume();
        paused = false;
        holder.removeAll();
        holder.add(board);
    ...
    private void resetGameButActionPerformed(ActionEvent evt) {//GEN-FIRST:event_resetGameButActionPerformed
        int[][] puzzle = sudoku.resetPuzzle();
        createBoard(puzzle);
    }//GEN-LAST:event_resetGameButActionPerformed

    private void newGameButActionPerformed(ActionEvent evt) {//GEN-FIRST:event_newGameButActionPerformed
        int[][] puzzle = sudoku.getNewPuzzle(grid, gameMode);
        createBoard(puzzle);
